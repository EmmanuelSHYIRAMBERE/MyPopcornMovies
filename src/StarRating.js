import { useRatingStore } from "./stateStore";
...
export default function StarRating({
  ...
  const tempRating = useRatingStore((state) => state.tempRating);
  const setTempRating = useRatingStore((state) => state.setTempRating);
